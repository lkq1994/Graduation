...
%         figure;plot(SignalReceive)
        ...
        signal_send1 = resample(SignalReceive,100035,100000);
...
%             signal = awgn(signal_send2,SNR,'measured');
            ...
            decode = Gdspreadenery(signal,fs,f0,N,PN,sourcelength);
            [a,b] = biterr(sourcecode01,decode);
           
            b_sum(ii) = b_sum(ii)+b;
          
            decode = dspreadenery(signal,fs,f0,N,PN,sourcelength);
            [a,c] = biterr(sourcecode01,decode);
