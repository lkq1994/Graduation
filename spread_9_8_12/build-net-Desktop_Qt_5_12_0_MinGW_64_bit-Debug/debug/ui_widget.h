...
public:
    ...
    void setupUi(QWidget *widget)
    {
        ...
        verticalLayout_3->addWidget(MessageBrowser);

        horizontalLayout_6 = new QHBoxLayout();
        horizontalLayout_6->setSpacing(6);
        horizontalLayout_6->setObjectName(QString::fromUtf8("horizontalLayout_6"));
        throld = new QLineEdit(widget);
        throld->setObjectName(QString::fromUtf8("throld"));

        horizontalLayout_6->addWidget(throld);
        ...
        SpreadLength = new QComboBox(widget);
        SpreadLength->addItem(QString());
        SpreadLength->addItem(QString());
        SpreadLength->addItem(QString());
        SpreadLength->addItem(QString());
        SpreadLength->addItem(QString());
        SpreadLength->setObjectName(QString::fromUtf8("SpreadLength"));

        horizontalLayout_6->addWidget(SpreadLength);
    ...
    void retranslateUi(QWidget *widget)
    {
        ...
        label_9->setText(QApplication::translate("widget", "\344\277\241\346\201\257", nullptr));
        label_6->setText(QApplication::translate("widget", "\351\227\250\351\231\220", nullptr));
        SpreadLength->setItemText(0, QApplication::translate("widget", "9", nullptr));
        SpreadLength->setItemText(1, QApplication::translate("widget", "10", nullptr));
        SpreadLength->setItemText(2, QApplication::translate("widget", "8", nullptr));
        SpreadLength->setItemText(3, QApplication::translate("widget", "7", nullptr));
        SpreadLength->setItemText(4, QApplication::translate("widget", "6", nullptr));

        label_10->setText(QApplication::translate("widget", "\346\211\251\351\242\221\345\272\217\345\210\227", nullptr));
